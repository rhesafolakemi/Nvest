  ...
  // search button 2
    $("button#search2").click(function(event){
      ...
      if ($("#usr2").val()==="mutual fund"){
        ...
        $("#descr2").append(fundMgt[2]);
        $("#benefits2").append(fundMgt[1]);
        $("#history2").append(mutualFund[0]);
